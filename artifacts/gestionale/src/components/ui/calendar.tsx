...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background/95 backdrop-blur-xl group/calendar p-5 sm:p-6 shadow-2xl border border-border/60 rounded-[1.5rem] [--cell-size:3.25rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=card-content]_&]:shadow-none [[data-slot=card-content]_&]:border-none [[data-slot=popover-content]_&]:bg-transparent [[data-slot=popover-content]_&]:shadow-none [[data-slot=popover-content]_&]:border-none",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-10 w-10 rounded-full select-none p-0 aria-disabled:opacity-50 transition-colors hover:bg-secondary hover:text-secondary-foreground shadow-sm border border-border/40",
        ...
        month_caption: cn(
          "flex h-10 w-full items-center justify-center font-bold tracking-tight text-foreground text-[18px] capitalize",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-[18px]"
            : "[&>svg]:text-muted-foreground flex h-9 items-center gap-1 rounded-md pl-2 pr-1 text-[18px] [&>svg]:size-5",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse mt-2",
        weekdays: cn("flex w-full mb-3 gap-1.5", defaultClassNames.weekdays),
        weekday: cn(
          "text-muted-foreground/80 flex h-8 w-[--cell-size] items-center justify-center select-none text-[13px] font-bold",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "flex aspect-square h-[--cell-size] w-[--cell-size] items-center justify-center rounded-full text-[16px] font-medium leading-none transition-all duration-300 ease-out",
